<x-layout>
  ...
  {{ $posts->links() }}
    ...
    <div class="py-4  my-4px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
             ...
             @forelse ($posts as $post )
              ...
              <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                  <div class="flex justify-between items-center mb-5 text-gray-500">
                    ...
                    <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-{{ $post->category->color }}-200 dark:text-primary-800">
                        {{ $post->category->name  }} 
                      </span>
                    </a>
